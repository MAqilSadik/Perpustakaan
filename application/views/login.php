    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h2 class="text-center text-dark mt-5">Tiga Serangkai Library</h2>
                <div class="card my-5">

                    <form class="card-body cardbody-color p-lg-5" method="post" action="<?php echo base_url('login/auth') ?>">

                        <div class="text-center">
                            <img src="assets/images/ts.jpg" class="img-fluid profile-image-pic img-thumbnail rounded-square my-3" width="200px" alt="profile">
                        </div>
